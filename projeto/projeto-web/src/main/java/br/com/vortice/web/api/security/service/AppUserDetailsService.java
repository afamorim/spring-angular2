...
import br.com.vortice.web.api.security.UsuarioSistema;
...
public class AppUserDetailsService implements UserDetailsService {
	...
	private Collection<? extends GrantedAuthority> getPermissoes(Usuario usuario) {
		...
		usuario.getPerfil().getPermissoes().forEach(p -> authorities.add(new SimpleGrantedAuthority(p.getDescricao().toUpperCase())));
		return authorities;
	}
